...
- Runtime: *T(<sub>n</sub>)* = *c<sub>1</sub>n* + *c<sub>2</sub>(n-1)* + *c<sub>4</sub>(n-1)* + *c<sub>5</sub>*<sub><img src="Week 2\c5.PNG" height="25px"/></sub> + <sub><img src="Week 2\c6.PNG" height="25px"/></sub> + <sub><img src="Week 2\c7.PNG" height="20px"/></sub> + <sub><img src="Week 2\c8.PNG" height="20px"/></sub>